...
def load_baseline(
    ...
    """Load only core baseline artifacts (balance + area-volume curve).

    GLEAM / IMERG dependencies are intentionally removed. Returned gleam_df and
    imerg_df are empty DataFrames kept for backward API compatibility.
    """
    ...
    if not balance_df.empty and "date" in balance_df.columns:
