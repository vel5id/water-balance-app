"""Process ERA5 runoff (ro) files into daily sums (mm/day).

Outputs:
  era5_runoff_mm.csv
  era5_runoff_mm.sqlite
"""
...
def convert(series: pd.Series, mode: str):
    if mode=='M_TO_MM': return series*1000.0
    return series
...
def main():
    ap=argparse.ArgumentParser(description='Process ERA5 runoff to daily mm.')
