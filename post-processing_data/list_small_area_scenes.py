import os
import pandas as pd
from _legacy.water_balance_model import SENTINEL_ROOT_DIR, find_sentinel_files, calculate_water_area

OUT_CSV = os.path.join(os.path.dirname(__file__), '..', 'processed_data', 'water_balance_output', 'small_area_scenes.csv')
