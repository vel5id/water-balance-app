...
## 2025-12-08 - [The Cone of Silence]
**Discovery:** Ensembles were generated by bootstrapping residuals around a fixed trend line, ignoring the uncertainty in the trend slope itself. This caused forecast spread to be constant over time, underestimating long-term risk.
**Protocol:** `build_robust_season_trend_series` now captures the analytical Confidence Interval of the Theil-Sen slope (via Scipy). This metadata is available to future ensemble generators to perturb the trend (Parameter Uncertainty).
