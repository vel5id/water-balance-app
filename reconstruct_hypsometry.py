...
Steps:
 ...
 7. Export new curve to processing_output/area_volume_curve_reconstructed.csv and comparison plot.

Run: python reconstruct_hypsometry.py --bathy Bathymetry/Main/bathymetry_hh.tif --dem "Hillshade + DEM/output_hh.tif" \
       --out processing_output --amax 93.7 --vmax 791 --hmax 19.8
...
def main():
    ...
    ap.add_argument('--out', default='processing_output', help='Output directory')
...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        print("Example usage: python reconstruct_hypsometry.py --bathy Bathymetry/Main/bathymetry_hh.tif --dem 'Hillshade + DEM/output_hh.tif' --out processing_output --amax 93.7 --vmax 791 --hmax 19.8")
    main()
