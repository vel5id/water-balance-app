"""Stub redirect for legacy_app_full_manual

The full manual legacy implementation has been moved to `_legacy/legacy_app_full_manual.py`.
This stub remains to avoid breaking any direct references or documentation.

Run modular app instead:
    streamlit run app.py
"""

import streamlit as st  # lightweight dependency only

st.title("Legacy manual app moved")
st.caption("Stub file: see _legacy/legacy_app_full_manual.py for (trimmed) snapshot")
st.info("Use modular app (app.py) for current functionality.")
